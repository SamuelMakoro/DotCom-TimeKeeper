  ...
  <div class="animated fadeIn">
    ...
    <b-row>
      ...
      <vs-tab @click="colorx = 'success'" vs-label="Add">
        ...
        <b-card>
          <div slot="header">
            <strong>Add Client Contract</strong>
            <b-row></b-row>
            <small> Enter Details of Client Contract</small>
          </div>
          <b-row>
            <b-col sm="9">
              <b-form-group>
                <label for="name">Client Username</label>
                <b-form-input type="text" id="name" placeholder="Enter Name of Client Company"></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
          <b-row>
            <b-col sm="4">
              <b-form-group>
                ...
                <b-form-input type="text" id="file-number" placeholder="Enter Contract File Number"></b-form-input>
              </b-form-group>
            </b-col>
            <b-col sm="4" offset-sm="1">
              <b-form-group>
                <label for="name">Allocated Hours</label>
                <b-form-input type="number" id="file-number" placeholder="Enter Number of Hours"></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
          <b-row>
            <b-col sm="4">
              <b-form-group
                label="Start Date" label-for="date"
                :label-cols="3"
                :horizontal="false">
          ...
          <b-row>
            <b-col sm="4">
              <b-form-group
                label="Review Date" label-for="date"
                :label-cols="3"
                :horizontal="false">
              <b-form-input type="date" id="date"></b-form-input>
              </b-form-group>
            ...
            <b-col sm="4" offset-sm="1">
              <b-form-group>
                ...
                <b-form-input type="number" id="file-number" placeholder="Enter Employee Rate"></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
          <b-row>
            <b-col sm="9">
              <b-form-group>
                ...
                <b-form-input type="text" id="contract-description" placeholder="Enter Description of Contract Stipulations"></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
        </b-card>
      ...
      <vs-tab @click="colorx = 'danger'" vs-label="Delete">
        <div class="con-tab-ejemplo">
          ...
          <div slot="header">
            <strong>Termination/Non-Renewal</strong>
            <b-row></b-row>
            <small>Enter Details about Contract Expiration</small>
          </div>
          <b-row>
            <b-col sm="9">
              <b-form-group
                  label="Conditions of Cancellation"
              ...
              <b-form-radio-group id="basicRadios"
                :plain="true"
                :options="[
                  {text: 'Non-Renewal',value: '1'},
                  {text: 'Termination',value: '2'},
              ]">
              </b-form-radio-group>
              </b-form-group>
            </b-col>
          ...
          <b-row>
            <b-col sm="9">
              <b-form-group>
                  <label for="contract-description">Cancellation Description</label>
                  <b-form-input type="text" id="contract-description" placeholder="Enter Description of the reason for contract cancelation."></b-form-input>
              </b-form-group>
            </b-col>
          </b-row>
        </b-card>
